...
function scheduleDay({ goals, exceptions = [], startOfDay = '09:00', focusWindows = [] }) {
  ...
  if (focusWindows[1] && g2 && g1 && g2.name !== g1.name) {
  ...
  tasks.unshift({ task: 'Bath and get ready', time: minToHhmm(startMinutes - 30), duration: 30 }, { task: 'Breakfast', time: minToHhmm(startMinutes), duration: 20 });
  tasks.push({ task: 'Lunch', time: '13:00', duration: 30 }, { task: 'Dinner', time: '19:00', duration: 30 }, { task: 'Evening walk', time: '20:00', duration: 15 });
